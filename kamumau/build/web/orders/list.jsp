        ...
        <div align="center" style="margin: 128px;">
            <div class="form-group">
                <select class="form-control" id="choose" name="choose" onchange="tableCondition(this.value)">
                    ...
                    <option selected="selected">Incoming orders</option>
            </select>
        </div>
...
                <tr onclick="DoNav('transactions?action=viewtransaction&order=<c:out value='${order.getNo()}' />&buyer_id=<c:out value='${order.getBuyer_id()}' />');"
